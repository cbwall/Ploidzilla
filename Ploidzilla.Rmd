...
blast<- blast %>% select(plug.ID, blastate.ml) # reduce columns

# merge with other data
cyto.SA<- merge(SA, mean.fluor, by = "plug.ID", all.x = TRUE)
cyto.SA<-na.omit(cyto.SA)

# merge in blastate
cyto.SA<- merge(cyto.SA, blast, by = "plug.ID", all.x = TRUE)
